                                                        ...
                                                        <div class="panel-body">
                                                            <strong>تعاونی مسکن کارکنان دادگستری</strong><br><em><%=user.get(0).get(Access_User._name)%> <%=user.get(0).get(Access_User._family)%></em><br><%=user.get(0).get(Access_User._address)%><br><%=user.get(0).get(Access_User._postalCode)%><br><%=user.get(0).get(Access_User._mobile)%>
                                                                            ...
                                                                            <div class="panel-footer clearfix  portfolio-filter" >
                                                                                <a style="width: 100%;text-align: center" data-filter=".hammer"  href="#" class="tp-caption sfl flat-button-slider bg-button-slider-32bfc0">
                                                                            ...
                                                                            <div class="col-md-9 pull-md-right">
                                                                                ...
                                                                                <div class="tiles clearfix">
                                                                                    <div class="row">
                                                                                        ...
                                                                                        <div class="col-sm-3 col-xs-6 tile portfolio-filter" onclick="">
                                                                                            <a href="#" data-filter=".AllInformation">
                                                                                        ...
                                                                                        <div class="col-sm-3 col-xs-6 tile portfolio-filter" onclick="">
                                                                                            <a href="#" data-filter=".table-cancle">
                                                                                    ...
                                                                                    <div class="col-xs-12 main-content">           
                                                                                        ...
                                                                                        <div class="announcement-single">
                                                                                            <h3>
                                                                                                ...
                                                                                                <a href="">در حال حاضر پروژه ای ندارید</a>
                                                                                            </h3>
                                                                                            <blockquote>
                                                                                                <p>
                                                                                        ...
                                                                                        <div class="announcement-single">
                                                                                            <h3>
                                                                                                ...
                                                                                                <a href="#"  onclick="selectProject(<%=projectMe.get(i).get(Content._id)%>)" ><%=projectMe.get(i).get(Content._title)%></a>
                                                                                            </h3>
                                                                                            <blockquote>
                                                                                                <p>
                                                                                    ...
                                                                                    <div class="col-xs-12 main-content">           
                                                                                        ...
                                                                                        <div class="announcement-single">
                                                                                            <h3>
                                                                                                ...
                                                                                                <a href="">در حال حاضر اطلاعیه ای ندارید</a>
                                                                                            </h3>
                                                                                            <blockquote>
                                                                                                <p>
                                                                                        ...
                                                                                        <div class="announcement-single">
                                                                                            <h3>
                                                                                                ...
                                                                                                <a href="#"  onclick="selectNews(<%=news.get(0).get(News._id)%>)" ><%=news.get(0).get(News._title)%></a>
                                                                                            </h3>
                                                                                            <blockquote>
                                                                                                <p>
                                                                                    ...
                                                                                    <div class="col-xs-12 main-content">           
                                                                                        ...
                                                                                        <div class="announcement-single">
                                                                                            <h3>
                                                                                                ...
                                                                                                <a href="https://clients.netafraz.com/announcements/93/%D8%A7%D8%AE%D8%AA%D9%84%D8%A7%D9%84-%D8%B3%D8%B1%D8%A7%D8%B3%D8%B1%DB%8C-%D8%AF%D8%B1-%D8%A7%DB%8C%D9%86%D8%AA%D8%B1%D9%86%D8%AA-%D8%A8%DB%8C%D9%86-%D8%A7%D9%84%D9%85%D9%84%D9%84.html">اختلال سراسری در اینترنت بین الملل</a>
                                                                                            </h3>
                                                                                            <blockquote>
                                                                                                <p>
                                                                                                    با سلام و احترام،با توجه به بروز مشکلات در شبکه زیرساخت کشور و اختلال در اتصال به شبکه بین الملل، این امر به صورت موقت باعث بروز مشکلاتی برای وب سایت های کاربرانی که وب سایت های ایشان در داخل یا ...
                                                                                                    <a href="https://clients.netafraz.com/announcements/93/%D8%A7%D8%AE%D8%AA%D9%84%D8%A7%D9%84-%D8%B3%D8%B1%D8%A7%D8%B3%D8%B1%DB%8C-%D8%AF%D8%B1-%D8%A7%DB%8C%D9%86%D8%AA%D8%B1%D9%86%D8%AA-%D8%A8%DB%8C%D9%86-%D8%A7%D9%84%D9%85%D9%84%D9%84.html" class="label label-warning">بیشتر »</a>
                                                                                                </p>
                                                                                            </blockquote>
                                                                                        </div>
                                                                                    </div>
                                                                                ...
                                                                                <div class="table-paid" style="display: none">
                                                                                                                ...
                                                                                                                <div class="row">
                                                                                                                    <input class="tp-caption sfl flat-button-slider bg-button-slider-32bfc0" id="sendPic1" type="submit" value="ارسال">
                                                                                                                        ...
                                                                                                                        <input class="form-control" id="user_file_personal" name="user_file_personal" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;" type="file">
                                                                                                                            ...
                                                                                                                            <a id="DownloadPicPersonal" href="" style="display: none" target="_blank" download="">
                                                                                                                                دانلود عکس پرسنلی
                                                                                                                            </a>
                                                                                                                                    ...
                                                                                                                                    <input class="form-control" id="user_titleFile" placeholder="فایل شما با این عنوان در سامانه ذخیره میشود" type="text" >
                                                                                                                                        <input id="attachFileUser" name="attachFileUser" onchange="$(this).parent().parent().find('.form-control').html($(this).val().split(/[\\|/]/).pop());" style="display: none;" type="file"><!--فایل انتخاب شده از بروزر-->
                                                                                                                                            <input class="tp-caption sfl flat-button-slider bg-button-slider-32bfc0" id="userAttachFiles_sendFiles" style="margin: 5px" type="submit" value="ارسال">
                                                                                                                                                ...
                                                                                                                                                <!--<span class="form-control"></span>-->
                                                                                                                                                <a   id="DownloadAttachFile" href="" style="display: none" target="_blank" download>
                                                                                                                                                    دانلود
                                                                                                                                                </a>
                                                                                                                                                </div>  
                                                                                                                                                </div>
                                                                                                                                                ...
                                                                                                                                                <div class="col-md-3 pull-md-left sidebar sidebar-secondary"  style="margin-left: 0px !important">
                                                                                                                                                    <div menuitemname="Client Contacts" class="panel panel-sidebar panel-sidebar">
                                                                                                                                                        ...
                                                                                                                                                        <div class="list-group  portfolio-filter">
                                                                                                                                                            <a  data-filter=".All"  href="#" class="list-group-item" id="Secondary_Sidebar-Client_Shortcuts-Order_New_Services">
                                                                                                                                                                &nbsp;                            داشبورد
                                                                                                                                                            </a>
                                                                                                                                                        </div>
