                                            ...
                                            <div class="iconbox left style2" style="width: 100%;height: 300px;">
                                                <img src="upload/<%=rowAll.get(b).get(Content._pic)%>" alt="serives">
                                                    <div class="box-content">
                                                        <div class="box-title">
                                                            <a onclick="sw('<%=rowAll.get(b).get(Content._title)%>')"><%=rowAll.get(b).get(Content._title)%></a>
                                                        </div>
                                                        <%=rowAll.get(b).get(Content._explain)%>                                                        
                                                    </div>
                                                    <ul class="portfolio-details">
                                                        <li><a  onclick="sw('<%=rowAll.get(b).get(Content._title)%>')"><i class="fa fa-external-link"></i></a></li>
                                                    </ul>
                                            </div>
                                        </div><%
                                            }
