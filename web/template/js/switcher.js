...
$(document).ready(function() {
	var e =  '<div class="switcher-container" style="display:none">'+
               ...
               '<div class="selector-box">'+
                    ...
                    '<div class="sw-pattern pattern"><h3>Background pattern:</h3>'+
                        '<a href="#" class="sw-pattern" data-image="template/img/1.png"><img src="template/img/1.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/2.png"><img src="template/img/2.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/3.png"><img src="template/img/3.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/4.png"><img src="template/img/4.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/5.png"><img src="template/img/5.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/6.png"><img src="template/img/6.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/7.png"><img src="template/img/7.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/8.png"><img src="template/img/8.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/9.png"><img src="template/img/9.png" alt="image"></a>' +
                        '<a href="#" class="sw-pattern" data-image="template/img/10.png"><img src="template/img/10.png" alt="image"></a>' +
                    '</div>'+               
                  '<div class="clearfix"></div>'+
               '</div>'+
            '</div>';
...
//        alert(e);
        $(t.headLink).attr("href", "template/colors/" + e + ".css");
