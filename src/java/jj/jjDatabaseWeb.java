...
public class jjDatabaseWeb {
    ...
    public static jjDatabaseWeb Db_Access(String userName, String password, String databasePath) {
        ...
        try {
            ...
            jjDatabaseWeb.url = "jdbc:odbc:Driver={Microsoft Access Driver (*.mdb" + (isExtensionACCDB ? ", *.accdb" : "") + ")};DBQ=" + databasePath + ";characterEncoding=UTF-8;useOldAliasMetadataBehavior=true;";
...
//==============================================================================
    ...
    public static List<Map<String, Object>> separateRow(DefaultTableModel dtm) {
        java.util.List<Map<String, Object>> parentMap = new java.util.ArrayList<>();
        if (dtm == null) {
            return parentMap;
        }
    ...
    public synchronized DefaultTableModel otherSelect(String query_select_join) {
        try {
            ...
            for (int i = 0; i < metaData.getColumnCount(); i++) {
                vColumns.add(metaData.getColumnLabel(i + 1));
            }
