                                                    ...
                                                    <div class="col-md-12">
                                                        <div class="flat-iconbox-carosuel-wrap">
                                                            <div class="flat-iconbox-carosuel" data-item="4" data-nav="false" data-dots="false" data-auto="false">
                                                                <%
                                                                    List<Map<String, Object>> row = jjDatabase.separateRow(db.Select(Product.tableName, Product._category_id + "=100"));
                                                                ...
                                                                <div class="iconbox-item root-back" style="padding: 5px 10px;text-align: right">
                                                                    <div class="iconbox  left square">
                                                                        <div class="box-header">
                                                                            ...
                                                                            <%}%>
                                                                            <div class="box-title"><a onclick=""><%=row.get(j).get(Product._name)%></a></div>
                                                                        </div>
                                                                        <%=row.get(j).get(Product._abstract)%>                                                                    
                                                                    </div>
                                                                </div>
                                                                <%}%>
                                                            </div>
                                                ...
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <div class="title-section style2 style3">
                                                            <h1 class="title">پروژه های در حال ساخت</h1>
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="row">
                                                    <div class="col-md-12">
                                                        <ul class="portfolio-filter">
                                                            ...
                                                            <li ><a data-filter=".builder"  href="#">باز سازی</a></li>
                                                            <li><a data-filter=".electric"  href="#">طراحی داخلی</a></li>
                                                            <li><a data-filter=".hammer"  href="#">معماری</a></li>
                                                        </ul>
                                                    </div>
                                                </div>
                                            </div>
